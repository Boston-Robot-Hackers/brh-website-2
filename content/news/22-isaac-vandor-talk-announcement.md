...
<a href="../../images/news/sentry.png">
    <img src="../../images/news/sentry.png" alt="Sample image" style="float: left; margin: 25px 25px 25px 25px; border-radius: 8px; height: 200px;">
</a>
