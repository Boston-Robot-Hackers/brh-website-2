...
class WebsiteBuilder:
    ...
    def __init__(self):
        ...
        self.content_types = {
            ...
            "projects": ContentType(
                "projects", "projects", detail_template="details/project-detail.html"
            ),
            "members": ContentType(
                "members",
                "members",
    ...
    def build_whatsnew(self) -> str:
        ...
        print(
            f"Generated {len(highlighted_posts)} highlighted posts "
    ...
    def build_news_page(self):
        ...
        print(
            f"Built whatsnew.html with {len(posts)} posts and {len(meetings)} meetings"
        )
