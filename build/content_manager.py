...
class ContentManager:
    ...
    def __init__(self, content_dir: Path):
        ...
        self.hero_builder = HeroBuilder(content_dir)
    ...
    def build_hero_content(self, page_name: str) -> Dict[str, Any]:
        ...
        if page_name == 'index':
            hero_content = self.hero_builder.generate_index_hero(hero_content)
